from collections import abc, OrderedDict # abc.Mapping dict , abc.Sequence list, tuple можно проверить также всех наследников
...
print(encode([{"yura":231}]))
print(decode(b'ld4:yurai231eee'))
